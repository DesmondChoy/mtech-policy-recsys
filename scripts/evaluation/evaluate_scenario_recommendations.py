...
GROUND_TRUTH_PATH = Path("data/evaluation/scenario_ground_truth.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--output_file",
        default=None,
        help="Optional path to save detailed evaluation results in JSON format (e.g., data/evaluation/scenario_evaluation_results.json).",
    )
